...
<ul id="login_pane">
	<li class="dropdown">
		<a data-toggle="dropdown" class="btn-border" href="{profile-link}">
			<b class="over">{login}</b><span title="Neue Nachrichten - {new-pm}" class="pm_num">{new-pm}</span>
		</a>
		<div class="dropdown-form dot logged">
			...
			<ul class="login_pane__menu">
				...
				<li><a href="{favorites-link}">Lesezeichen <span class="right grey"><b>{favorite-count}</b></span></a></li>
				<li><a href="{newposts-link}">Ungelesene Nachrichten</a></li>
			</ul>
			<div class="login_pane__foot">
				<a class="right" href="{logout-link}">Abmelden</a>
				<a href="{addnews-link}"><span class="plus_icon circle"><span>+</span></span>Nachricht hinzufügen</a>
			</div>
		</div>
	</li>
</ul>
...
<ul id="login_pane">
	<li class="dropdown">
		<a data-toggle="dropdown" class="btn-border" href="#"><b>Anmelden</b></a>
		<form class="dropdown-form dot" method="post">
			...
			<ul class="login_form">
				...
				<li class="login_input-btn">
					...
					<input placeholder="Passwort" type="password" name="login_password" id="login_password">
					<svg class="icon icon-pass"><use xlink:href="#icon-pass"></use></svg>
					<button class="btn" onclick="submit();" type="submit" title="Anmelden">
						<svg class="icon icon-right"><use xlink:href="#icon-right"></use></svg>
						<span class="title_hide">Anmelden</span>
					</button>
				</li>
			</ul>
			<input name="login" type="hidden" id="login" value="submit">
			<div class="login_form__foot">
				<a class="right" href="{registration-link}"><b>Registrierung</b></a>
				<a href="{lostpassword-link}">Passwort vergessen?</a>
			</div>
		</form>
	</li>
