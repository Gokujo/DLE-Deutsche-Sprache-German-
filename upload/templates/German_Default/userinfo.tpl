<article class="box story">
	<div class="box_in dark_top userinfo_top">
		<ul class="title user_tab h1">
			<li class="active"><a href="#user1" data-toggle="tab">[group=5]Benutzer [/group]{usertitle}</a></li>
			[not-logged]<li><a href="#user2" data-toggle="tab">Bearbeiten</a></li>[/not-logged]
					...
					<div class="addform">
						<ul class="ui-form">
							...
							<li class="form-group">
								...
								<textarea placeholder="Beispiele: 192.48.25.71 oder Maske 129.42.0.0/16 oder mit Sternen 129.42.*.*" name="allowed_ip" id="allowed_ip" rows="5" class="field wide">{allowed-ip}</textarea>
							</li>
							[/group]
							<li class="form-group">
								<table class="xfields">
						...
						<div class="form_submit">
							<button class="btn btn-big" name="submit" type="submit"><b>Speichern</b></button>
							[delete]<b>Konto löschen</b>[/delete]
