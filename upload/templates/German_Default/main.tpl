<!DOCTYPE html>
<html[available=lostpassword|register] class="page_form_style"[/available] lang="de">
<head>
	{headers}
...
<body>
				...
				<div class="header">
					<div class="wrp">
						...
						<div id="cat_menu">
							...
							<div class="soc_links">
								<a class="soc_vk" href="#" title="Wir bei VKontakte">
									<svg class="icon icon-vk"><use xlink:href="#icon-vk"></use></svg>
								</a>
								<a class="soc_tw" href="#" title="Wir bei Twitter">
									<svg class="icon icon-tw"><use xlink:href="#icon-tw"></use></svg>
								</a>
								<a class="soc_fb" href="#" title="Wir bei Facebook">
									<svg class="icon icon-fb"><use xlink:href="#icon-fb"></use></svg>
								</a>
								<a class="soc_gp" href="#" title="Wir bei Google">
			...
			<div class="conteiner">
				<div class="midside">
					...
					<section id="content">
						...
						<div class="box">
							<h1 class="heading h4">Neueste Kommentare</h1>
							<div class="com_list">
								{content}
							</div>
						</div>
	...
	[available=lostpassword|register]
		<div class="page_form">
			<a class="page_form__back" href="/" title="Zurück zur Startseite"><svg class="icon icon-left"><use xlink:href="#icon-left"></use></svg></a>
