	...
	<div id="login_drop" class="head_drop">
		<div class="hd_pad">
			...
			<ul class="login_pane__menu">
				<li><a href="{pm-link}">Nachrichten <span class="right"><b>{new-pm}</b> von {all-pm}</span></a></li>
				<li><a href="{favorites-link}">Lesezeichen <span class="right"><b>{favorite-count}</b></span></a></li>
				<li><a href="{newposts-link}">Ungelesene Nachrichten</a></li>
			</ul>
			<div class="login_pane__foot">
				<a class="right" href="{logout-link}">Abmelden</a>
				<a href="{addnews-link}"><span class="plus_icon"><span>+</span></span>Nachricht</a>
			</div>
		</div>
	</div>
	[/not-group]
			...
			<form class="login_form" method="post">
				...
				<ul>
					...
					<li class="form-group">
						...
						<input placeholder="Passwort" type="password" name="login_password" id="login_password" class="wide">
					</li>
					<li>
