[available=main]
<!-- Karussell (http://getbootstrap.com/javascript/#carousel) -->
<div id="carousel-main" class="carousel slide" data-ride="carousel">
	<a class="slide_prev" href="#carousel-main" role="button" data-slide="prev" title="Zurück">
		<span>
	...
	<a class="slide_next" href="#carousel-main" role="button" data-slide="next" title="Vorwärts">
		<span>
