<article class="block story shortstory">
	...
	<ul class="story_icons">
		<li class="fav_btn">
			...
			[del-favorites]<span title="Aus Lesezeichen entfernen"><svg class="icon icon-fav_del"><use xlink:href="#icon-fav_del"></use></svg></span>[/del-favorites]
		</li>
		<li class="edit_btn">
	...
	<div class="story_tools">
		<div class="story_tools_in">
			<a href="{full-link}" title="Mehr lesen: {title}" class="btn"><span class="more_icon"><i></i><i></i><i></i></span></a>
		[rating]
			<div class="rate">
		...
		<ul class="meta grey">
			<li class="meta_author" title="Autor">
				<svg class="icon icon-author"><use xlink:href="#icon-author"></use></svg>{author}
			</li>
			<li class="meta_coms" title="Kommentare: {comments-num}">[com-link]<svg class="icon icon-coms"><use xlink:href="#icon-coms"></use></svg>{comments-num}[/com-link]</li>
			<li class="meta_views" title="Aufrufe: {views}"><svg class="icon icon-view"><use xlink:href="#icon-view"></use></svg>{views}</li>
		</ul>
	</div>
</article>