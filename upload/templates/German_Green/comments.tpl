<div class="comment[online] online[/online]" id="{comment-id}">
	...
	[/not-group]
		<div class="com_tools_links grey">
			[fast]<svg class="icon icon-reply"><use xlink:href="#icon-reply"></use></svg><span>Zitieren</span>[/fast]
			[treecomments] 
			[reply]<svg class="icon icon-reply"><use xlink:href="#icon-reply"></use></svg><span>Antworten</span>[/reply]
			[/treecomments]
			[complaint]<svg class="icon icon-compl"><use xlink:href="#icon-compl"></use></svg><span>Beschwerde</span>[/complaint]
			[com-del]<svg class="icon icon-del"><use xlink:href="#icon-del"></use></svg><span>Löschen</span>[/com-del]
		</div>
	</div>
</div>