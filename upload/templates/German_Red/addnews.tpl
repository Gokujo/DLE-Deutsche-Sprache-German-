	...
	<div class="wrp">
		...
		<div class="grid_3_4">
			<ul class="ui-form">
				...
				<li class="form-group">
					<a class="btn btn_border" href="#" onclick="$('.addvote').toggle();return false;">Umfrage hinzufügen</a>
				</li>
				...
				<li class="form-group addvote" style="display:none;" >
					<label for="vote_body">Antwortoptionen</label>
					<p class="grey">Jede neue Zeile ist eine neue Antwortoption</p>
					<textarea name="vote_body" id="vote_body" rows="10" class="wide" >{votebody}</textarea>
					<div class="checkbox">
						<label class="form-check-label"><input class="form-check-input" type="checkbox" name="allow_m_vote" id="allow_m_vote" value="1" {allowmvote}><span>Mehrere Optionen auswählen erlauben</span></label>
					</div>
				</li>
				[allow-shortstory]
				<li class="form-group imp">
			...
			<div class="form_submit">
				...
				<button id="add_news_preview" class="btn btn_border" onclick="preview()" type="submit" name="nview"><b class="ultrabold">Vorschau</b></button>
			</div>
		</div>
	</div>
</article>