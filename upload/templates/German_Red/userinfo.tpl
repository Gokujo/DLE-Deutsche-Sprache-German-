<div class="block story shadow">
	<div class="wrp">
		<div class="userinfo_top">
			...
			<div class="head">
				<h1 class="title h2 ultrabold">Benutzer: {usertitle}</h1>
			</div>
		...
		<div class="tab-content">
			<div class="tab-pane active" id="user1">
				...
				<ul class="usinf">
					...
					<li><div class="ui-c1 grey">Website-Rating</div> <div class="ui-c2">{rate}</div></li>
				</ul>
				<h4 class="ultrabold grey">Über sich</h4>
				<p>{info}</p>
				[signature]
				...
				<div id="options">
					<div class="addform">
						<ul class="ui-form">
							...
							<li class="form-group form-sep"></li>
							<li class="form-group">
								<label for="info">Über sich</label>
