	...
	<div class="com_content">
		...
		<div class="com_tools">
			...
			<div class="com_tools_links grey">
				[fast]<svg class="icon icon-meta_reply"><use xlink:href="#icon-meta_reply"></use></svg><span>Zitieren</span>[/fast]
				[treecomments] 
					[reply]<svg class="icon icon-meta_reply"><use xlink:href="#icon-meta_reply"></use></svg><span>Antworten</span>[/reply]
				[/treecomments] 
				[com-del]<svg class="icon icon-cross"><use xlink:href="#icon-cross"></use></svg><span>Löschen</span>[/com-del]
