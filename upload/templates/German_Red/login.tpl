[not-group=5]
<a id="login" class="h_btn login" href="{profile-link}" title="{login}, Nachrichten {new-pm}">
...
<div id="loginpane" class="droptopbar loggedpane">
	<div class="wrp">
		...
		<ul class="login_menu">
			<li>
				<a href="{pm-link}"><b class="lm_num">{new-pm}</b>Nachrichten</a>
			</li>
			<li>
				<a href="{favorites-link}"><b class="lm_num">{favorite-count}</b>Lesezeichen</a>
			</li>
			<li>
				<a href="{logout-link}">Abmelden</a>
			</li>
		</ul>
...
<form class="droptopbar" id="loginpane" method="post">
	<div class="wrp">
		...
		<div class="login_form_links">
			<a href="{registration-link}">Registrierung</a>
